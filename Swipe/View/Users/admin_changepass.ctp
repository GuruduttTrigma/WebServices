    ...
    <div id="dyn" class="hiddenpars">
             <?php echo $this->Form->create('User',array('action'=>'admin_changepass','id'=>'validate')); ?><div class="formRow">
                ...
                <div class="formRow">
                    ...
                    <div class="grid9">
                    <?php echo $this->Form->input('password', array('label'=>"",'Placeholder'=>'New Password...','type'=>'password','required','minlength'=>'3'));?>
                    </div>
                </div>
                <div class="formRow">
                    <div class="grid3"><label>Confirm Password:</label></div>
                    <div class="grid9">
                    <?php echo $this->Form->input('cpass', array('label'=>"",'Placeholder'=>'Confirm Password...','type'=>'password','required','minlength'=>'3'));?>
                    </div>
                </div> 
                <div class="formRow">
