...
<div class="loginWrapper">
   ...
   <?php echo $this->Form->create('User',array('method'=>'post','id'=>'loginForm')); ?>
		...
		<span><?php echo $this->Html->image(FULL_BASE_URL.$this->webroot.'assets/img/login-logo.png',array('width'=>'100')); ?></span>
      <span>Reset Your Credentials</span>
		...
		<input type="text" name="data[User][email]" value="<?php echo @$user_info['User']['email'];?>" placeholder="Email">
