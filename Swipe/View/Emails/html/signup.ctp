...
<!--100% body table-->
<table cellspacing="0" border="0" cellpadding="0" style="margin: 5% auto; width: 800px;">
	<tr>
		<td>
			<!--top links-->
			<!--header-->
						...
						<table border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td valign="top" style="float:left;   margin: 10px;" >
									 <img src="http://admin.talentswipe.com/assets/img/talant-swipe-logo.png" alt="Logo">
								</td>
							</tr>
						</table><!--ribbon-->
					</td>
			...
			<table width="800" border="0" align="center"bgcolor="#3790BC" cellpadding="0" cellspacing="0">
				<tr>
					<td valign="top" class="address">
						<p style="color: #fff; font-size: 15px; line-height: 45px;text-align: center;width: 100%;">
							If you need to contact us please email <a href="#">admin@swipe.com</a>
						</p>
					</td>
				</tr>
			</table>
