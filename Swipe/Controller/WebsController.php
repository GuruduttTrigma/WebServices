<?php
	...
	class WebsController extends AppController 
	{
		...
		# //http://dev414.trigma.us/N-166/Webservices/signup?username=gurudutt1&first_name=guru&last_name=sharma&profile_image=profileimage2.png&email=gurudutt.sharma@trigma.in&register_type=manual&password=123456&conpassword=123456
		...
		//http://dev414.trigma.us/N-166/Webservices/userProfile?id=3&user_id=14
		...
		{  
			...
			if ($this->User->exists	())  {    				
				...
				$userViewVideo	=	$this->User->find ('first',array('conditions'=>  array('User.id'=>$user_id),'contain'=>array('VideoView.all_video_id')));
				$userVideoView 	= 	array();
		...
		// dev414.trigma.us/N-166/Webserviceservices/profile_edit?id=2285&username=rahul&profile=manager&profile_image=profileimage2.png&dob=456&first_name=guru123&last_name=sharm
		...
		//http://dev414.trigma.us/N-166/Webservices/all_videos_of_user?user_id=2285&category_id=all
		...
		//http://dev414.trigma.us/N-166/Webservices/all_videos_by_category_id?category_id=1&user_id=12
		public function all_videos_by_category_id ()
		{
			...
			//echo "<pre>";print_r($alluserVideoView);
		...
		//http://dev414.trigma.us/N-166/Webservices/remove_video?video_id=1
		...
		//http://dev414.trigma.us/N-166/Webservices/favorite_video_of_user?user_id=2314
		...
		//http://dev414.trigma.us/N-166/Webservices/video_views?video_id=1
		...
		//http://dev414.trigma.us/N-166/Webservices/send_msg?user_id=5&msg=hiiwwwwwwwwww;
		function send_msg ()  {
			...
			$l 							= new CakeEmail();
			$l->emailFormat ('html')->template ('feedback', 'fancy')->subject ('App User Suggestions & Feedback')->to ($admin_email)->cc('puneesh.goyal@trigma.com')->from ($user_email)->send($ms);
