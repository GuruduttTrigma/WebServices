 ...
 */
	public function admin_edit($id = null) {
        ...
        @$inner_logo = $this->Sitesetting->find('first',array('fields'=>array('inner_logo')));    
			...
			$two = $this->request->data['Sitesetting']['inner_logo'];
			if($two['name']){
			$this->request->data['Sitesetting']['inner_logo'] = $two['name'];
			}else{$this->request->data['Sitesetting']['inner_logo']= @$inner_logo['Sitesetting']['inner_logo'];
			}            
			...
			if ($two['error'] == 0) {
			$pth = 'files' . DS .$two['name'];
			move_uploaded_file($two['tmp_name'], $pth);                   
			}					
				$this->Session->setFlash(__('The sitesetting has been saved'));
				$this->redirect(array('action' => 'index'));
			} else {
 ...
 */
	public function admin_delete($id = null) {
       ...
       public function admin_webservice() {	
