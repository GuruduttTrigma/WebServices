						...
						if(!empty($val)){
							...
							$totalFriend = $this->nearbytotal($val['lat'],$val['lng']);
								if(!empty($totalFriend)){
									if($totalFriend<=1 && $totalFriend>=199){
										$totalEarn='0.01';
									} else if($totalFriend>=200 && $totalFriend<=399){
										$totalEarn='0.02';
									} else if($totalFriend>=400 && $totalFriend<=599){
										$totalEarn='0.04';
									} else if($totalFriend>=600 && $totalFriend<=799){
										$totalEarn='0.06';
									} else if($totalFriend>=800 && $totalFriend<=999){
										$totalEarn='0.08';
									} else {
										$totalEarn='0.10';
									}
