		   ...
		   $postId = $_REQUEST['post_id'];
			if($shared_id!='' && $postId!=''){
					...
					$totalFriends = $userDetails['User']['fb_friend'];
						if($totalFriends>0){
							/* if($totalFriends<=1 && $totalFriends>=199){
								$totalEarn='0.01';
							} else if($totalFriends>=200 && $totalFriends<=399){
								$totalEarn='0.02';
							} else if($totalFriends>=400 && $totalFriends<=599){
								$totalEarn='0.04';
							} else if($totalFriends>=600 && $totalFriends<=799){
								$totalEarn='0.06';
							} else if($totalFriends>=800 && $totalFriends<=999){
								$totalEarn='0.08';
							} else {
								$totalEarn='0.10';
							} */
						...
						if(!empty($val)){
							...
							$totalFriend = $this->nearbytotal($val['lat'],$val['lng']);
								if(!empty($totalFriend)){
									...
									/* echo "<pre>";print_r($earn);exit;
									if($totalFriend<=1 && $totalFriend>=49){
										$totalEarn='0.02';
									} else if($totalFriend>=50 && $totalFriend<=99){
										$totalEarn='0.05';
									} else if($totalFriend>=100 && $totalFriend<=149){
										$totalEarn='0.10';
									} else if($totalFriend>=150 && $totalFriend<=199){
										$totalEarn='0.12';
									} else if($totalFriend>=200 && $totalFriend<=249){
										$totalEarn='0.15';
									}
									else if($totalFriend>=250 && $totalFriend<=299){
										$totalEarn='0.17';
									}
									else if($totalFriend>=300 && $totalFriend<=349){
										$totalEarn='0.20';
									}else if($totalFriend>=350 && $totalFriend<=399){
										$totalEarn='0.22';
									}
									else if($totalFriend>=400 && $totalFriend<=449){
										$totalEarn='0.25';
									}
									else if($totalFriend>=450 && $totalFriend<=499){
										$totalEarn='0.27';
									}
									else if($totalFriend>=500 && $totalFriend<=549){
										$totalEarn='0.30';
									}
									else if($totalFriend>=550 && $totalFriend<=599){
										$totalEarn='0.32';
									}
									else if($totalFriend>=600 && $totalFriend<=649){
										$totalEarn='0.35';
									}
									else if($totalFriend>=650 && $totalFriend<=799){
										$totalEarn='0.37';
									}
									else if($totalFriend>=800 && $totalFriend<=849){
										$totalEarn='0.40';
									}
									else if($totalFriend>=850 && $totalFriend<=899){
										$totalEarn='0.42';
									}
									else if($totalFriend>=900 && $totalFriend<=949){
										$totalEarn='0.45';
									}
									else if($totalFriend>=950 && $totalFriend<=999){
										$totalEarn='0.47';
									}
									else if($totalFriend>=1000 && $totalFriend<=10000){
										$totalEarn='0.50';
									} */
